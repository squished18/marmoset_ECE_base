...
public class Student  implements Comparable {
    ...
    /**  By Omar Nafees
     * Looks up  all student that have userids "containing" -remoteUser-
     * 
     * @param studentPK the PK of the student record
     * @param connection the connection to the database
     * @return the student record if it is found, null otherwise
     * @throws SQLException
     */
    public static Map<String, Student> lookupAllRemoteUserStudentGroups(String remoteUser, Connection connection)
    throws SQLException
    {

        String query = " SELECT " +ATTRIBUTES+
        " FROM students WHERE students.campus_uid = '" + remoteUser + "'" 
		+ "OR students.campus_uid = '" + remoteUser + "-student'"
		+ "OR students.campus_uid = '" + remoteUser + "-canonical'"
		+ "OR students.campus_uid RLIKE '-" + remoteUser + "-'";
