			...
			<table>
				...
				<c:forEach var="test"
					...
					<tr class="r${numDisplayed % 2}">
						...
						<td class="description"><span style="background: #FFE799; font-family: monospace; white-space: pre; border: 1px solid #FFDB66; letter-spacing: 1px"><c:out value="${test.longTestResult}" /></span></td>
		...
		<table class="testResults">
			...
			<c:forEach var="test" items="${testOutcomeCollection.publicOutcomes}">
				...
				<tr class="r${numDisplayed % 2}">
					...
					<c:otherwise>
<span style="background: #FFE799; font-family: monospace; white-space: pre; border: 1px solid #FFDB66; letter-spacing: 1px"><c:out value="${test.longTestResult}" /></span>
					</c:otherwise>
					</c:choose>
					</td>
				</tr>
						...
						<c:choose>
							<c:when test="${failedTests <= project.numReleaseTestsRevealed}">
								...
								<c:choose>
                                                    ...
                                                    <td class="description"><span style="background: #FFE799; font-family: monospace; white-space: pre; border: 1px solid #FFDB66; letter-spacing: 1px"><c:out	value="${release.longTestResult}" /></span></td>
